---
title: MinterGenericError
editUrl: false
next: true
prev: true
---

Defined in: packages/canisters/ckbtc/errors/minter.errors.d.ts:2
...
- [`MinterTemporaryUnavailableError`](MinterTemporaryUnavailableError.md)
- [`MinterAlreadyProcessingError`](MinterAlreadyProcessingError.md)
