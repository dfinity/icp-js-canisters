 ...
 */
export type millikoinu_per_byte = bigint;
...
export interface _SERVICE {
  dogecoin_get_balance: ActorMethod<[get_balance_request], amount>;
  dogecoin_get_balance_query: ActorMethod<[get_balance_request], amount>;
  dogecoin_get_block_headers: ActorMethod<
    [get_block_headers_request],
    get_block_headers_response
  >;
  dogecoin_get_current_fee_percentiles: ActorMethod<
    [get_current_fee_percentiles_request],
    BigUint64Array
  >;
  dogecoin_get_utxos: ActorMethod<[get_utxos_request], get_utxos_response>;
  dogecoin_get_utxos_query: ActorMethod<
    [get_utxos_request],
    get_utxos_response
  >;
  dogecoin_send_transaction: ActorMethod<[send_transaction_request], undefined>;
